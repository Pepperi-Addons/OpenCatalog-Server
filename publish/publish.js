...
async function publishNewVersion(client, request) {
...
async function populateNewVersion(client, request) {
...
async function deleteVersionFromElasticSearch(client, request) {
...
async function uploadNewVersion(client, atdID, atdKey, elasticSearchSubType) {
...
async function uploadBaseItems(client, pepperiClientAPI, elasticSearchSubType, fields, indexedFields, nonIndexedFields, transactionUUID, atdID) {
    ...
    nonIndexedFields.forEach(field => {
        ...
        switch (atdField === null || atdField === void 0 ? void 0 : atdField.Format) {
            case 'String':
            case 'Guid':
...
exports.deleteVersionFromElasticSearch = deleteVersionFromElasticSearch;
exports.populateNewVersion = populateNewVersion;
exports.publishNewVersion = publishNewVersion;
